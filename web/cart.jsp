<%-- 
    Document   : cart
    Created on : 15-Oct-2023, 01:54:57
    Author     : ADMIN
--%>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${cart}" var="entry">
                                        <tr>
                                            <td><img src="${entry.value.product.image}" alt="Product Image" width="80px" height="80px"></td>
                                            <td>${entry.value.product.pName}</td>
                                            <td>${entry.value.product.price * 1.5}</td>
                                            <td>
                                                <a href="updateCart?pID=${entry.key}&action=decrease" class="quantity-control">-</a>
                                                <span class="quantity">${entry.value.quantity}</span>
                                                <a href="updateCart?pID=${entry.key}&action=increase" class="quantity-control">+</a>
                                            </td>
                                            <td>${entry.value.product.price * entry.value.quantity * 1.5}</td>
                                            <td>
                                                <a href="removeFromCart?pid=${entry.key}" class="remove-button">REMOVE</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
